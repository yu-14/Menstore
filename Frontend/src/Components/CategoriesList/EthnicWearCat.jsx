...
import ethnicWearList from "../../../public/assets/TraditionalWearList";

const EthnicWearCat = ({ category, setCategory }) => {
  return (
    <div className="flex flex-col items-center  gap-6 mt-6 px-5 w-full">
      <div className="flex items-center gap-6 justify-center overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-400 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent w-full px-4">
        {ethnicWearList.map((item, index) => (
          <div
            key={index}
