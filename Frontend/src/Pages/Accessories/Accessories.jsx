...
import AccessoriesList from "../../../public/assets/AccessoriesItems";
import { ThemeContext } from "../../Context/ThemeContext";
import CategoriesList from "../../Components/CategoriesList/AccessoriesCat";
import { Link } from "react-router-dom";

const Accessories = () => {
  const { theme } = useContext(ThemeContext);
  const [search, setSearch] = useState("");
  const [filteredProducts, setFilteredProducts] = useState(AccessoriesList);
