...
import groomingList from "/public/assets/grooming";
...
const Grooming = () => {
  ...
  const [filteredProducts, setFilteredProducts] = useState(groomingList);
  ...
  const handleSearch = (e) => {
    ...
    const filtered = groomingList.filter((product) =>
